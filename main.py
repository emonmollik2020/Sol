...
# ডিফল্ট স্টেট (টু-ওয়ে ফিউচার্স ও ডাবল চেকলিস্ট অনুযায়ী সাজানো)
DEFAULT_STATE = {
    "price": 0.0,
...
<div class="max-w-md mx-auto">
    ...
    <div class="card p-4 mb-4 text-[11px]">
        ...
        <div class="grid grid-cols-2 gap-2 text-slate-600 font-semibold" id="checklist_container">
            <!-- ডাইনামিক চেকলিস্ট আইটেম রেন্ডারিং -->
        </div>
    </div>
    ...
    async function update() {
        try {
            ...
            if (d.price > 0) {
                ...
                // --- ডাইনামিক টু-ওয়ে চেকলিস্ট রেন্ডারিং ---
