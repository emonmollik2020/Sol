...
<div class="max-w-md mx-auto">
    ...
    <!-- কনফ্লুয়েন্স ডাবল চেকলিস্ট প্যানেল (দ্বিমুখী টু-ওয়ে ভিউ) -->
    <div class="card p-4 mb-4 text-[11px]">
        ...
        <div class="border-b pb-3 mb-3 border-slate-100">
            ...
            <div class="grid grid-cols-2 gap-2 text-slate-600 font-semibold" id="long_checklist">
                <!-- জাভাস্ক্রিপ্ট রেন্ডার করবে -->
            </div>
        </div>

        <!-- SHORT কন্ডিশনস (বিক্রয়) -->
        <div>
            <p class="text-[10px] font-black text-red-700 mb-2 flex items-center gap-1">🔴 SHORT MODE (ডাউনট্রেন্ড কন্ডিশনস) 📉</p>
            <div class="grid grid-cols-2 gap-2 text-slate-600 font-semibold" id="short_checklist">
                <!-- জাভাস্ক্রিপ্ট রেন্ডার করবে -->
            </div>
        </div>
    </div>
    ...
    async function update() {
        try {
            ...
            if (d.price > 0) {
                ...
                // --- ডাইনামিক ডাবল চেকলিস্ট রেন্ডারিং ---
