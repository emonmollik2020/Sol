...
# সুইং ও ট্রেন্ড ট্রেডিংয়ের জন্য স্ট্যান্ডার্ড স্টপ লস ও টেক প্রফিট (ATR দিয়ে এটি ডাইনামিক হবে)
DEF_TP = 0.035  
DEF_SL = 0.020  
...
def get_advanced_pats(df):
    ...
    if b1 > 0 and u1 >= 1.8 * b1 Barbarian_short = True if u1 >= 1.8 * b1 else False
...
def bot_engine():
    ...
    while True:
        try:
            ...
            # ড্যাশবোর্ডের জন্য চেকলিস্ট ও স্টেট কনф্লুয়েন্স ডিকশনারি তৈরি
            confluences = {
            ...
            if in_pos:
                ...
                cur["wait_reason"] = "비টিসি ট্রেন্ড ডাউন (BTC BEARISH)"
            elif btc_bullish and p < e200:
                cur["wait_reason"] = "비টিসি ট্রেন্ড আপ (SOL SHORT এর উপযুক্ত নয়)"
...
<script>
    ...
    // TradingView Lightweight Charts ইনিশিয়ালাইজ করা (ডার্ক এক্সচেঞ্জ থিম)
    const chartContainer = document.getElementById('chart_container');
    const chart = LightweightCharts.createChart(chartContainer, {
        width: chartContainer.clientWidth,
        height: 240,
        layout: {
            background: { type: 'vertical', color1: '#1e293b', color2: '#0f172a' }, // ডার্ক নিওন থিম
            textColor: '#94a3b8',
        },
        grid: {
    ...
    async function update() {
        try {
            ...
            if (d.price > 0) {
                ...
                // চার্টের ওপরে ক্যান্ডেলস্টিক বাই/সেল মার্কার রেন্ডার করা (Execution Markers)
                ...
                // চার্ট মার্কার অ্যারে তৈরি
                let chart_markers = [];
                if (d.history && d.history.length > 0) {
                    for (let h of d.history.slice(0, 10)) {
                        // হিস্ট্রি থেকে বাই/সেল টাইমস্ট্যাম্প কনভার্ট করা
                    ...
                    // টাইমস্ট্যাম্প অনুযায়ী মার্কারগুলো সাজানো
