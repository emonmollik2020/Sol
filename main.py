...
# ডিফল্ট স্টেট (টু-ওয়ে ফিউচার্স, ৮টি কন্ডিশন ও এস্টিমেটেড টাইম অনুযায়ী সাজানো)
DEFAULT_STATE = {
    "price": 0.0,
    ...
    "pos_size": 0.0,  
    "margin": 0.0,    
    "est_time": "লোড হচ্ছে...", # এস্টিমেটেড টাইম ট্র্যাকিং
...
<div class="max-w-md mx-auto">
    ...
    <div class="card p-4 mb-4 text-[11px]">
        ...
        <div class="border-b pb-3 mb-3 border-slate-100">
            <p class="text-[10px] font-black text-green-700 mb-2 flex items-center gap-1">🟢 LONG MODE (আপট্রেন্ড কন্ডিশস) 📈</p>
    ...
    async function update() {
        try {
            ...
            if (d.price > 0) {
                ...
                // লাইভ ট্রেড ওপেন থাকলে প্রফিট-বক্স ও এক্সিট চেকলিস্ট শো করা
