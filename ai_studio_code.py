...
def bot_engine():
    ...
    while True:
        try:
            ...
            # ১৫মি চার্টে ডাইনামিক ২০-পিরিয়ড ব্রেকআউট লজিক (বাস্তবসম্মত ১৫মি ব্রেকআউট কনফার্মেশন)
            ...
            # ফিক্স ১: btc_bearish-এর পাশে থাকা nodding টাইপোটি সম্পূর্ণ এবং স্থায়ীভাবে সংশোধন করা হয়েছে
